    ...
    <div className="mx-auto max-w-2xl px-4 py-6 sm:py-10">
      ...
      <div className="flex flex-col gap-6 text-base leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          {CONTACT_FORM_URL ? (
            <p className="mt-2">
              お問い合わせフォームにはGoogleフォームを利用しています。送信された内容(お問い合わせの種類・
              本文・任意でご記入いただいたメールアドレス)は、Googleのサーバー上に保存され、運営者が確認します。
              フォーム側でメールアドレスを自動収集する設定にはしておらず、Googleアカウントへのログインも不要です。
              返信をご希望の場合のみ、任意でメールアドレスをご記入ください。ご記入いただいた情報は
              お問い合わせへの対応以外の目的には使用しません。
            </p>
          ) : (
            <p>お問い合わせ窓口は準備中です。</p>
          )}
