...
export const metadata: Metadata = {
  ...
  description:
    "金やプラチナを売却したときに税金がかかるかどうかを、イラスト付きでやさしく解説。生活用動産の非課税ルール、1個30万円超の例外、インゴット(地金)の譲渡所得と特別控除、地金を200万円超で売った場合の支払調書などをまとめました。",
...
const faq = [
  ...
  },
  {
    ...
    a: "古物営業法にもとづく本人確認の手続きで、中古品を買い取る店が一般に負っている義務です。怪しまれているわけではありません。なお、これとは別に、金地金・金貨などを1回あたり200万円を超えて買い取った業者には、税務署へ「金地金等の譲渡の対価の支払調書」を提出する義務があります(指輪やネックレスなどの宝飾品は対象外です)。",
  },
];
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:py-10">
      ...
      <div className="flex flex-col gap-5 sm:gap-6">
        ...
        <GuideCard icon={<IdCardIcon />} title="身分証を求められる理由と、200万円超の報告">
          買取店で身分証の提示を求められるのは、古物営業法にもとづく本人確認の手続きです。
          怪しまれているからではなく、中古品を買い取る店が一般に負っている義務です。
        </GuideCard>

        <GuideCard icon={<IdCardIcon />} title="地金・金貨を200万円超で売ると税務署に報告される">
          これとは別に、金地金・金貨などを1回あたり200万円を超えて買い取った業者は、
          税務署へ「金地金等の譲渡の対価の支払調書」を提出する決まりになっています。
          対象は地金や金貨などで、指輪やネックレスといった宝飾品の売却はこの調書の対象外です。
        </GuideCard>
